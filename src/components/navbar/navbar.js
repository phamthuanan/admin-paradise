    ...
    render() {
        return (
            <header className="header dark-bg">
                ...
                <a href="index.html" className="logo"><img src = 'logo.png' alt = 'logo.png' style = {{    height: "30px"}} /></a>
                        ...
                        <li className="dropdown">
                            <a data-toggle="dropdown" className="dropdown-toggle" href="#">
                                <span className="profile-ava">
                                    <img alt="" src={"http://localhost:8080/avatar/" + this.props.avatar} style ={{width : '30px', height : '30px'}}/>
                                </span>
                            ...
                            <ul className="dropdown-menu extended logout">
                                ...
                                <li className="eborder-top">
                                    <a href="#"><i className="icon_profile"></i> Tài khoản</a>
                                </li>
                                <li>
                                    <a onClick={() => this.props.logout()} style ={{cursor : 'pointer'}}><i className="icon_key_alt"></i> Đăng xuất</a>
                                </li>
                            </ul>
                        </li>
